...
public class ServletUtils {
	...
	/**
	 * 设置让浏览器弹出下载对话框的Header.(对上面方法的一个扩展,多了一个可以自己指定的参数charset)
	 * 
	 * @param fileName 下载后的文件名.
	 * @param charset 编码字符集.
	 */
	public static void setFileDownloadHeader(HttpServletResponse response, String fileName, String charset) {
		try {
			//中文文件名支持

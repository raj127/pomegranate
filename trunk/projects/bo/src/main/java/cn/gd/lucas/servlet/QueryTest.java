...
public class QueryTest extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
				...
				queryAndShow(request, response, "中山大学", "sysu", "0");
			
		} catch (Throwable e) {
			wr.write("查询出错，请联系管理员");
			wr.flush();
			wr.close();
		}
	...
	private void queryAndShow(HttpServletRequest request,
			HttpServletResponse response, String q, String db,
		...
		RequestDispatcher rd = request.getRequestDispatcher("/search/ResultShow.jsp");

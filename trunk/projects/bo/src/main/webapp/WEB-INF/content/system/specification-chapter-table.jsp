	...
	<form id="mainForm" action="specification-chapter-table.action" method="post">
		...
		<div id="content">
			<table id="contentTable">
				<tr>
					<th width="10%"><a href="javascript:sort('name','asc')">章节名称</a></th>
					<th><a href="javascript:sort('content','asc')">章节内容</a></th>
					<th width="5%"><a href="javascript:sort('isLeaf','asc')">叶子节点</a></th>
					<th width="10%">操作</th>
				</tr>

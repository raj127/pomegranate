/**
 *	来源: http://revolunet.github.com/VLCcontrols/src/jquery.html jquery + vlc 页面整合的js
 * 	修改: by MagicY(杨乐):2011-6-3
 * 	修改内容：增加了addPlaylist的js API，并作出若干细小修改
 *  注意：本js还有很多不完善的细节,比如全屏，没有音量操作等
 */
...
var VLCobject = {
        ...
        */
        ...
        ,embedPlayer:function(replaceElemIdStr, widthStr, heightStr, add_toolbar) {
                ...
                aboutTxt = "";
                if (instance.version()) {
                    aboutTxt = 'version de VLC install�e : ' + instance.version();
                    
                }
                else {
                    var url = "http://www.videolan.org/vlc/";
                    aboutTxt = "VLC non detect�. <a href='" + url + "' target='blank'>cliquez ici pour l'installer</a>";
                }
                
                /*aboutTxt += '<br>widget cr�e par <a href="http://www.revolunet.com" target="blank" title="conseil intranet">revolunet</a>. &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" target="blank" >aide</a>';
